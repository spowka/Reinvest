...
import { TerminalOwnersService } from '../../../shared/terminal-owners/terminal-owners.service';
...
export class InfoTerminalComponent implements OnInit {
  ...
  public terminalOwners: any[] = null;
  ...
  constructor(
    ...
    private terminalOwnersService: TerminalOwnersService,
    ...
    this.terminalOwnersService.getTerminalOwners('active', {}).subscribe(
      (data: any) => {
        this.terminalOwners = data.terminalOwners.map(t => ({
  ...
  public get isDataReady() {
    return this.terminal && this.terminalOwners && this.publishCatalogTree && this.imageCatalogTree;
  }
